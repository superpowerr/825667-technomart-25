...
var tabsLink = document.querySelectorAll(".service-item a");
var currentTab = document.querySelector(".service-item .active");
var currentTabContent = document.querySelector(".service-info-wrap .active");

var currentSlide = 0;
var slides = document.querySelectorAll(".services-slider section");
...
if (slides) {
  ...
  var nextSlide = document.querySelector('.services-slider .next-slide');
  var previousSlide = document.querySelector('.services-slider .previous-slide');
